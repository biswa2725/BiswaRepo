...
public class AnnotationsTestNG {
	...
	public void testCurrentUrl() throws InterruptedException {
		driver.findElement(By.xpath("//a[@class='aside__menu__link active']")).click();
		Thread.sleep(6000);
		String currentUrl = driver.getCurrentUrl();
		Assert.assertEquals(currentUrl, "https://automation.lambdatest.com/timeline/?viewType=build&page=1",
				"url did not matched");
	...
	public void screenShot() throws IOException {
		...
		FileUtils.copyFile(file1, new File("D:\\test1.PNG"));
