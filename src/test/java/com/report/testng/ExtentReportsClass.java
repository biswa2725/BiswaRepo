...
public class ExtentReportsClass {
	...
	public void startReport() {
		...
		extent.addSystemInfo("Host Name", "BiswaTesting").addSystemInfo("Environment", "Automation Testing")
				.addSystemInfo("User Name", "Biswajit");
		...
		extent.loadConfig(new File(System.getProperty("user.dir") + "\\src\\main\\rseources\\extent-config.xml"));
	}
